...
По запросу (название компании) найди и верни достоверную информацию о компании.

Правила:
- Возвращай ТОЛЬКО достоверные данные, которые ты знаешь наверняка.
- Если не уверен в каком-то поле — оставь его пустой строкой "".
- НЕ выдумывай ИНН, ОГРН и другие регистрационные номера — эти поля НЕ нужно заполнять.
